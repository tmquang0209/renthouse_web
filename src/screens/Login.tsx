        ...
        <>
            ...
            <div className="py-[50px] wrapper bg-gradient-to-r from-blue-200 via-purple-200 to-gray-200 flex flex-col gap-[35px] items-center">
                <div className="p-[28px] bg-white flex flex-col gap-[30px] mx-auto">
                    <div className="">
                        <h1 className="text-[22px] text-textColor font-[500] mb-[15px]">Đăng nhập</h1>
                    ...
                    <div className="flex flex-row gap-[30px]">
                            ...
                            >
                                <div className="flex flex-col gap-[10px] ">
                                    <div className="flex flex-row items-center gap-[6px] ">
                                        <label className="text-[16px] text-textColor" htmlFor="username">Tài khoản</label>
                                        <div className="">
                                ...
                                <div className="flex flex-row items-center justify-between">
                                    <div className="flex flex-row items-center gap-[12px] ">
                                        <input
                                            className="rounded-md border border-gray-300 bg-gray-300 shadow-md w-[20px] h-[20px] flex-shrink-0"
                                            type="checkbox"
                                        />
                                        <h3 className="text-[16px] text-textColor font-[400] leading-[24px]">Ghi nhớ đăng nhập</h3>
                                    </div>
                                    <Link 
                                        to=""
                        ...
                        <div className="flex flex-col gap-[40px] ">
                            ...
                            <div className="flex flex-col gap-[20px]">
                                ...
                                <Link to="/register" className="w-[324px] py-[14px] rounded-[4px] font-[600] text-colorBtn bg-white border-[1.5px]  border-[#4B7BE5] text-center filter drop-shadow-md">
                                    Tạo tài khoản mới
                                </Link>
                            </div>
                        </div>
                ...
                <div className="flex flex-row gap-[15px] items-center">
                    ...
                    <Link  className="text-[20px] font-[400] text-colorBtn " to="/register">Đăng ký</Link>
                </div>
            </div>
        </>
    );
